...
export const ALTERNATIVAS = [
  ...
  { valor: 'RNF', rotulo: 'Requisito não funcional', atalho: 'B', icone: 'fa-solid fa-gauge-high' },
  { valor: 'RN', rotulo: 'Regra de negócio', atalho: 'C', icone: 'fa-solid fa-scale-balanced' },
  { valor: 'NAO_CONDIZ_COM_TEMA', rotulo: 'Não condiz com o tema', atalho: 'D', icone: 'fa-solid fa-ban' }
];
